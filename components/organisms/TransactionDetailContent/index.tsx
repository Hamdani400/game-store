                    ...
                    <div className="main-content main-content-card overflow-auto">
                        <section className="checkout mx-auto">
                            ...
                            <div className="purchase pt-30">
                                ...
                                <Row label="Your Game ID" value="Hamdani Dinul Haq" />
                                <Row label="Order ID" value="GG00912" />
                                <Row label="Item" value="Diamonds" />
                                <Row label="Price" value={1200000} />
                                <Row label="Tax (5%)" value={6000} />
                                <Row label="Total" value={1260000} className="color-palette-4" />
                            </div>
                            <div className="payment pt-10 pb-10">
                                <h2 className="fw-bold text-xl color-palette-1 mb-20">Payment Informations</h2>
                                <Row label="Your Account Name" value="Hamdani Dinul H" />
                                <Row label="Type" value="Worldwide Transfer" />
                                <Row label="Bank Name" value="BCA" />
                                <Row label="Bank Account" value="PT. Toko Game Indonesia" />
                                <Row label="Bank Number" value={347676891} />
                            </div>
